...
{
    public partial class BookContainer : Form
    {
        ...
        private void studentEntryToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            studentEntryForm.WindowState = FormWindowState.Maximized;
            studentEntryForm.Show();
        }

        private void bookListToolStripMenuItem_Click(object sender, EventArgs e)
        {
            BookListForm BookEntryForm = new BookListForm();
            BookEntryForm.WindowState = FormWindowState.Maximized;
            BookEntryForm.Show();
        }
    }
}
